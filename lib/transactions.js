...
var generateOutputTransactions = function (poolRecipient, recipients, rpcData, poolOptions) {
    ...
    /* Dash 0.12.1/0.13 */
    if (rpcData.masternode_payments_enforced && rpcData.masternode) {
    ...
    if (rpcData.superblocks_enabled && rpcData.superblock && rpcData.superblock.length > 0) {
...
exports.CreateGeneration = function (rpcData, publicKey, extraNoncePlaceholder, reward, txMessages, recipients, poolOptions) {
    ...
    var txComment = txMessages === true ?
        util.serializeString('https://github.com/nasa8x/node-open-mining-portal') :
        Buffer.from([]);
